...
function buildPrompt(
  ...
  return joinPromptLines([
    ...
    "Use those prices only—do not synthesize new series. Whenever you reference returns, time in market, or drawdown, call the calculate_expression tool, display the formula you evaluated (e.g., (final_equity - initial_capital) / initial_capital), round the result to at most 5 decimal places, and limit yourself to at most two calculate_expression calls total.",
    "Every numeric value you mention—including those copied from the simulation—must be rounded to at most five decimal places before returning the JSON.",
    ...
    "Return one JSON object per the schema below. Keep the language approachable—focus on insights, strategy tips, and risks/mitigations instead of referencing internal code terms.",
    "",
    "Projection data (JSON):",
    projectionPayload,
    "",
    "Pre-computed strategy data (JSON):",
    simulationPayload,
    "",
