...
function buildPrompt(
  ...
  return joinPromptLines([
    ...
    "",
    "STEP 1: Call the MCP forecast tool (get_forecast) with:",
    `- asset_id: "${assetId}"`,
    '- forecast_type: "long"',
    ...
    '- vs_currency: "usd"',
    "",
    "STEP 2: The tool returns { chart: { history: [...], projection: [...] }, forecast: {...} }",
    "Include the chart object directly in your response as chart_data.",
    "",
    "Return a JSON response with:",
    "1. Your insight analysis (schema below)",
    "2. chart_data: <the chart object from the MCP tool response>",
    "",
    ...
    '  },',
    '  "chart_data": <insert the chart object from MCP tool here>',
    "}",
    "",
