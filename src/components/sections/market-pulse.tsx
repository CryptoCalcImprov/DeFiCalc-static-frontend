    ...
    <div className="space-y-8">
      <div className="grid gap-4 sm:grid-cols-3">
        {marketPulse.totals.map((stat) => (
          <div key={stat.label} className="rounded-3xl border border-slate-800/70 bg-slate-950/70 p-5">
        ...
        <div className="rounded-3xl border border-slate-800/70 bg-slate-950/70 p-6">
          ...
          <ul className="mt-4 space-y-3 text-sm text-slate-200">
            {marketPulse.alerts.map((alert) => (
              <li key={alert.title} className="rounded-2xl border border-slate-800/70 bg-slate-900/60 p-4">
